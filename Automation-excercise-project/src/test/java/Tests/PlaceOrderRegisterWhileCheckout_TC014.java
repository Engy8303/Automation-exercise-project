...
public class PlaceOrderRegisterWhileCheckout_TC014 {
    ...
    public void beforeClass() throws FileNotFoundException {
        System.out.println(">>>>>>> Before Class: PlaceOrderRegisterWhileCheckout_TC014 <<<<<<<");
    ...
    public void afterClass() {
        System.out.println(">>>>>>> After Class: PlaceOrderRegisterWhileCheckout_TC014 <<<<<<<");
    }
    ...
    @Description("Verify user can register during checkout and place order successfully")
    public void PlaceOrderRegisterWhileCheckout(Register register) {
