...
public class PlaceOrderRegisterBeforeCheckout_TC015 {
    ...
    public void beforeClass() throws FileNotFoundException {
        System.out.println(">>>>>>> Before Class: PlaceOrderRegisterBeforeCheckout_TC015 <<<<<<<");
    ...
    public void afterClass() {
        System.out.println(">>>>>>> After Class: PlaceOrderRegisterBeforeCheckout_TC015 <<<<<<<");
    }
    ...
    @Description("Verify user can register before checkout and place order successfully")
    public void PlaceOrderRegisterBeforeCheckout(Register register) {
